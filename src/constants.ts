...
export const CREATURE_ARCHETYPE_LABELS: Record<string, string> = {
  orb: "Orb",
  "tall-parasite": "Tall Parasite",
  "segmented-worm": "Segmented Worm",
  "floating-prism": "Floating Prism",
  "asymmetrical-blob": "Asym Blob",
  "crystalline-cluster": "Crystal Cluster",
  "tripod-reactor": "Tripod Reactor",
  "split-body-mutant": "Split Body",
  "halo-organism": "Halo Organism",
  "jellyfish-entity": "Jellyfish Entity",
  "biomech-eye": "Biomech Eye",
  "spiral-core": "Spiral Core",
};
